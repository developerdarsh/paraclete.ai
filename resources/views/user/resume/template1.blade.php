    ...
    <div class="auto-container" style="width: 100%; max-width: 750px; margin-right: auto; margin-left: auto;">
        <div class="top-header" style="background-color: #303030;width: 100%;display: inline-block;">
            <div class="logo" style="width: 30%;height: 140px;float: left;">
                ...
                @else
                    <img src="{{URL::asset('img/resume/default_img.jpg')}}" style="width: 100%;height: 178px;object-fit: cover;object-position: center;" />
                @endif    
            </div>
            <div class="User-Info" style="">
                <div class="User_Name" style="padding: 15px;">
                    <h2 style="margin: 0px; padding: 0px; font-size: 24px; line-height: 30px; font-weight: bold; color: #ffffff;">{{ $data['first_name'] }} {{ $data['last_name'] }}</h2>
                    <p style="padding: 0px;margin: 0px;color: #ffffff;">{{ $data['jobTitleInput'] }}</p>
                </div>
                <div class="User_Address" style="padding: 10px 15px 5px;">
                    <p style="margin: 0; padding: 0; color: #ffffff; font-size: 14px; line-height: 16px;">{{ $data['address'] }} {{ $data['city'] }}, {{ $data['country'] }}-{{ $data['postal_code'] }}</p>
        ...
        <div class="personal-details" style="width: 100%;position: relative;display: inline-block;">
            <div class="left-part" style="width: 30%;float: left;">
                <div class="skill" style="padding: 20px 20px 0px"> 
                     ...
                     <ul style="list-style: none;padding: 0px;">
                        ...
                        <li style="font-size: 12px;line-height: 16px;margin: 0px;padding:0px;">
                            ...
                            <div style="width: 100%;display: inline-block;background: #cecece;height: 4px;">
                                @if(isset($data['skill_level_'.$key]) && ($data['skill_level_'.$key]=='novice'))
                                <div style="float: left;width: 20%;height: 4px;background: #000000;"></div>
                                @endif

                                @if(isset($data['skill_level_'.$key]) && ($data['skill_level_'.$key]=='beginner'))
                                <div style="float: left;width: 40%;height: 4px;background: #000000;"></div>
                                @endif

                                @if(isset($data['skill_level_'.$key]) && ($data['skill_level_'.$key]=='intermediate'))
                                <div style="float: left;width: 60%;height: 4px;background: #000000;"></div>
                                @endif

                                @if(isset($data['skill_level_'.$key]) && ($data['skill_level_'.$key]=='advanced'))
                ...
                <div class="links" style="padding: 20px 20px 0px;">
                    @if(isset($data['link_link']))
                ...
                <div class="language" style="padding: 20px 20px;">
            ...
            <div class="Profile-sec" style="width: 70%;float: right;">
                <div style="padding: 20px 20px 0px;"> 
                    ...
                    <div class="Employment-History"> 
                        ...
                        <ul class="skill-list" style="padding: 0px;padding-bottom: 20px;margin: 0px;">
                           <p style="font-size: 12px;line-height: 16px;margin: 0px;padding-bottom: 10px;"> {{ $data['emp_description'][$key] }}</p>
                         </ul>
                         @endforeach
                    </div>
                    <div class="Education"> 
