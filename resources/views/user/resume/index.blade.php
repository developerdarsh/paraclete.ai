    ...
    <header class="header-1">
        <div class="container">
           <!-- <div class="sec-title text-center mb-3">
                 <h2>Untitled</h2>
                 <a href="#"><img src="{{URL::asset('img/resume/flag.png')}}" alt="" /> English</a>
           </div>
            ...
            <div class="resume-templates">
                ...
                <div class="template-images">
                    <div class="slider lazy">
                        <div class="img">
                            <img data-lazy="{{URL::asset('img/resume/template1.jpg')}}" alt="Template 1" onclick="selectTemplate(this, '1')"/>
                        </div>
                        <div class="img">
                            <img data-lazy="{{URL::asset('img/resume/template2.jpg')}}" alt="Template 2" onclick="selectTemplate(this, '2')">
                        </div>
                        <div class="img">
                            <img data-lazy="{{URL::asset('img/resume/template3.jpg')}}" alt="Template 3" onclick="selectTemplate(this, '3')">
                        </div>
                        <div class="img">
                            <img data-lazy="{{URL::asset('img/resume/template4.jpg')}}" alt="Template 4" onclick="selectTemplate(this, '4')"/>
                        </div>
                        <div class="img">
                            <img data-lazy="{{URL::asset('img/resume/template5.jpg')}}" alt="Template 5" onclick="selectTemplate(this, '5')"/>
                        </div>
                    </div>
                </div>
            ...
            @csrf
                <div class="row">
                    ...
                    <div class="form-group mb-4">
                            <input type="hidden" name="template_image" id="template_img">
                            <label class="form-label">Wanted Job Title</label>
                            ...
                            <div class="work-experiences" id="workExperiences"> 
                                <div class="accordion mb-4" id="accordionExample">
                                    <div class="accordion-item">
                                        ...
                                        <button class="btn btn-danger btn-sm delete-button" onclick="deleteSection(this)"><i class="fa-regular fa-trash-can"></i></button>
...
@section('js')
    ...
    <script>
        ...
        function addEmploymentForm() {
            ...
            var accordionItem = clonedForm.querySelector(".accordion");
            if (accordionItem) {
                accordionItem.insertBefore(deleteButton, accordionItem.querySelector(".delete-button"));
            }
        ...
        function addEducationForm() {
            ...
            var accordionItem = clonedEducation.querySelector(".accordion");
            if (accordionItem) {
                accordionItem.insertBefore(deleteButton, accordionItem.querySelector(".delete-button"));
            }
        ...
        function addWebsitesLink() {
            ...
            var accordionItem = clonedLink.querySelector(".accordion");
            if (accordionItem) {
                accordionItem.insertBefore(deleteButton, accordionItem.querySelector(".delete-button"));
            }
        ...
        // Function to add a new language form
        function addLanguageForm() {
            var languageSection = document.getElementById("AddLanguages"); // Corrected variable name
            var clonedForm = languageSection.querySelector(".accordion-item").cloneNode(true);

            // Update IDs and other attributes to make them unique
            var currentId = new Date().getTime(); // Unique ID based on current timestamp
            clonedForm.querySelector(".accordion-header").setAttribute("id", "languages_heading_" + currentId);
            clonedForm.querySelector(".accordion-button").setAttribute("data-bs-target", "#languages_collapse_" + currentId);
            clonedForm.querySelector(".accordion-collapse").setAttribute("id", "languages_collapse_" + currentId);
            ...
            languageSection.querySelector(".accordion").appendChild(clonedForm);
        }

        // Function to delete the section
        function deleteSection(button) {
            var section = button.closest('.accordion-item');
            if (section) {
                section.remove();
            }
        }
        ...
        function addSkillForm() {
            ...
            var deleteButton = clonedForm.querySelector(".delete-button");
            if (!deleteButton) {
                ...
                var accordionHeader = clonedForm.querySelector(".accordion-header");
        ...
        $(document).ready(function(){
            ...
            $(".AddMore skill a").on('click', function() {
                console.log("addd more section");
                addSkillForm();
            });
        ...
        $(document).on('click', '.tm-content a, .div_editor1', function(e) {
            e.preventDefault();
            var currentContent = editor1.getHTMLCode();
            var objectiveText = $(this).text().trim();
            var newText = '<p>' + objectiveText + '</p>'; // Wrap the text in <p> tags
            editor1.setHTMLCode(currentContent + newText);
        ...
        $(document).on('click', '.custom-box', function(e) {
            ...
            if(sectionType == 1){
                $('#customSections').append(courseSectionHTML);
            }else if(sectionType == 2){
                $('#customSections').append(hobbiesSectionHTML);
            }else if(sectionType == 3){
                $('#customSections').append(extraSectionHTML);
            }else{
                $('#customSections').append(referenceSectionHTML);
            }
        ...
        function addCourseForm() {
            ...
            // Append the delete button to the cloned course section
            var accordionItem = clonedCourse.querySelector(".accordion");
            if (accordionItem) {
        ...
        function addHobbiesForm() {
            ...
            // Append the delete button to the cloned hobbies section
            var accordionItem = clonedHobbies.querySelector(".accordion");
            if (accordionItem) {
                accordionItem.insertBefore(deleteButton, accordionItem.querySelector(".delete-button"));
            }
        ...
        function addExtraCurricularForm() {
            ...
            // Append the delete button to the cloned Extra-curricular Activities section
            var accordionItem = clonedExtraCurricular.querySelector(".accordion");
            if (accordionItem) {
                accordionItem.insertBefore(deleteButton, accordionItem.querySelector(".delete-button"));
            }
        ...
        function addReferenceForm() {
            ...
            // Append the delete button to the cloned Reference section
            var accordionItem = clonedReference.querySelector(".accordion");
            if (accordionItem) {
                accordionItem.insertBefore(deleteButton, accordionItem.querySelector(".delete-button"));
            }
        ...
        function selectTemplate(element, templateId) {
            var templateImages = document.querySelectorAll(".template-images img");
            templateImages.forEach(img => img.classList.remove("selected"));
            element.classList.add("selected");
            document.getElementById('template_img').value = templateId;
        }
    </script>
@endsection