         ...
         <div class="header-section" style="width: 100%; display: inline-block;position: relative;padding: 20px 10px;">
            <div class="profile-details" style="width: 70%;float: left;">
               <div style="padding: 20px 15px;">
                  <h1 style="margin: 0px;font-size: 42px;line-height: 54px;font-weight: bold;padding-bottom: 10px;text-transform: uppercase;letter-spacing: 2px;color: #000000;font-family: 'Arimo', sans-serif;"><?php echo e($data['first_name']); ?> <?php echo e($data['last_name']); ?></h1>
                  <div style="background: #2b2b2b;padding: 10px 10px;width: 300px;">
                     <h4 style="margin: 0px;color: #ffffff;font-size: 20px;line-height: 26px;text-transform: uppercase;font-weight: 300;letter-spacing: 2px;"><span><?php echo e($data['jobTitleInput']); ?></span></h4>
                  </div>
               </div>
            </div>
            <div class="profile-image" style="width: 25%;float: left;text-align: center;">
                 <?php if($base64URL): ?>
                    <img src="<?php echo e($base64URL); ?>" style="width: 140px;height: 140px;object-fit: cover;object-position: center;border-radius: 100%;padding: 7px;background: #2b2b2b;box-shadow: 2px 3px 38px 0px rgba(3, 3, 3, 0.23);">
                <?php else: ?>
                    <img src="<?php echo e(URL::asset('img/resume/man-3803551_1280.jpg')); ?>" style="width: 140px;height: 140px;object-fit: cover;object-position: center;border-radius: 100%;padding: 7px;background: #2b2b2b;box-shadow: 2px 3px 38px 0px rgba(3, 3, 3, 0.23);">
                <?php endif; ?> 
            </div>
         </div>
            ...
            <div class="left-part" style="width: 60%; float: left;">
              <div style="padding: 10px;">
               <div class="summury-text" style="padding: 10px 20px 0px;">
                  ...
                  <p style="font-size: 14px;line-height: 24px;margin: 0px;padding-bottom: 10px;"><?php echo e(strip_tags($data['professional_summary'])); ?>
                  ...
                  <div class="experiences-box">
                    <?php $__currentLoopData = $data['emp_job_title']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$job_title): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <div style="padding-bottom: 20px;">
                        <h4 style="margin: 0px;margin-bottom: 5px;font-size: 16px;line-height: 24px;text-transform: uppercase;"><?php echo e($job_title); ?></h4>
                        <p style="margin: 0px;font-size: 14px;line-height: 20px;"><?php echo e($data['emp_employer'][$key]); ?></p>
                        <p style="margin: 0px;font-size: 14px;line-height: 20px;"><?php echo e(date('M Y',strtotime($data['emp_start_date'][$key]))); ?> - <?php echo e(date('M Y',strtotime($data['emp_end_date'][$key]))); ?></p>
                        <ul style="padding-left: 20px;">
                           <li style="font-size: 14px;line-height: 20px;margin: 0px;margin-bottom: 10px;"><?php echo e($data['emp_description'][$key]); ?>
               ...
               <div class="languages" style="padding: 0px 20px 0px;">
                ...
                <?php $__currentLoopData = $data['lang_name']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                   <li style="font-size: 14px;line-height: 20px;margin: 0px;margin-bottom: 10px;"> <span style="padding-left: 10px;font-size: 14px;line-height: 20px;"><?php echo e($language); ?></span></li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
             </div>
             <div class="eduction-text" style="padding: 0px 20px 0px;">
                  ...
                  <div class="eduction-list" style="padding-bottom: 10px;">
                     <h4 style="margin: 0px;margin-bottom: 5px;letter-spacing: 2px;font-size: 16px;line-height: 24px;font-weight: bold;text-transform: uppercase;"><?php echo e($education); ?></h4>
                     <p style="font-size: 14px;line-height: 24px;margin: 0px;padding-bottom: 0px;"><?php echo e($data['edu_degree'][$key]); ?> </p>
                     <p style="font-size: 14px;line-height: 24px;margin: 0px;padding-bottom: 0px;"><?php echo e(date('M Y',strtotime($data['edu_start_date'][$key]))); ?> - <?php echo e(date('M Y',strtotime($data['edu_end_date'][$key]))); ?></p>
                  </div>
                   <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
               </div>
                ...
                <div class="Extra-curricular" style="width: 100%;display: inline-block;padding: 10px 20px 0px;">
                 <div style="border-bottom: 1px solid #3d3d3d;padding: 10px 0px;margin-bottom: 25px;">
                    ...
                    <div class="Extra-list" style="margin-bottom: 10px;">
                        <h3 style="font-size: 16px;line-height: 24px;margin: 0px;padding-bottom: 10px;font-weight: 400;"><?php echo e($eca); ?> <span style="font-weight: bold;">at <?php echo e($data['eca_employer'][$key]); ?>,<?php echo e($data['eca_city'][$key]); ?></span> </h3>
               ...
               <div class="skills" style="padding: 20px 20px 0px;">
                  ...
                  <ul style="margin: 0px;padding-left: 20px;">
                    <?php $__currentLoopData = $data['skill_title']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$skills): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <li style="font-size: 14px;line-height: 20px;margin: 0px;margin-bottom: 10px;"><?php echo e($skills); ?>
               ...
               <div class="links" style="padding: 0px 20px 0px;">
                ...
                <div class="courses" style="width: 100%;display: inline-block;padding: 20px 15px 0px;">
                  <div style="border-bottom: 1px solid #3d3d3d;padding: 10px 0px;margin-bottom: 25px;">
                    ...
                    <div class="courses-list" style="margin-bottom: 10px;">
                        <h3 style="font-size: 16px;line-height: 24px;margin: 0px;padding-bottom: 10px;font-weight: 400;"><?php echo e($courses); ?> <span style="font-weight: bold;">at <?php echo e($data['cur_institution'][$key]); ?></span> </h3>
                        <p style="color: #222222;font-size: 14px;line-height: 20px;margin: 0;font-weight: 400;padding-bottom: 10px;"><?php echo e(date('M Y',strtotime($data['cur_start_date'][$key]))); ?> - <?php echo e(date('M Y',strtotime($data['cur_end_date'][$key]))); ?></p>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <?php endif; ?>
                ...
                <div class="References" style="padding: 20px 20px 0px;">
                    ...
                    <div class="eduction-list">
                       <h4 style="margin: 0px;margin-bottom: 5px;letter-spacing: 2px;font-size: 20px;line-height: 24px;font-weight: bold;"><?php echo e($refrance); ?></h4>
                       <p style="font-size: 14px;line-height: 20px;margin: 0px;padding-bottom: 5px;"><?php echo e($data['ref_company'][$key]); ?></p>
                       <p style="font-size: 14px;line-height: 20px;margin: 0px;padding-bottom: 5px;"><?php echo e($data['ref_email'][$key]); ?></p>
                       <p style="font-size: 14px;line-height: 20px;margin: 0px;padding-bottom: 5px;"><?php echo e($data['ref_phone'][$key]); ?></p>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <?php endif; ?>
                ...
                <div style="padding-bottom: 15px;width: 100%;display: inline-block;">
                  <div style="float: left;width: 10%;margin-right: 10px;">
                      <div style="width: 28px;height: 28px;background: #ffffff;text-align: center;border-radius: 100%;"> 
                         <img src="<?php echo e(URL::asset('img/resume/phone-call.svg')); ?>" alt="call" style="width: 16px;height: 16px;margin-top: 6px;">
                     </div>
                  </div>
                  <div style="overflow: hidden;margin-left: 40px;"><p style="font-size: 14px;line-height: 24px;margin: 0px;color: #ffffff;font-weight: 300;"><?php echo e($data['phone']); ?></p></div>
               </div>
                  <div style="padding-bottom: 15px;width: 100%;display: inline-block;">
                    <div style="float: left;width: 10%;margin-right: 10px;">
                      <div style="width: 28px;height: 28px;background: #ffffff;text-align: center;border-radius: 100%;"> 
                         <img src="<?php echo e(URL::asset('img/resume/email.png')); ?>" alt="email" style="width: 16px;height: 16px;margin-top: 6px;">
                       </div>
                    </div>
                    <div style="overflow: hidden;margin-left: 40px;"><p style="font-size: 14px;line-height: 24px;margin: 0px;color: #ffffff;font-weight: 300;"><?php echo e($data['email']); ?> </p></div>
                 </div>
                 <div style="padding-bottom: 15px;width: 100%;display: inline-block;">
                  <div style="float: left;width: 10%;margin-right: 10px;">
                    <div style="width: 28px;height: 28px;background: #ffffff;text-align: center;border-radius: 100%;"> 
                        <img src="<?php echo e(URL::asset('img/resume/location.png')); ?>" alt="addresh" style="width: 16px;height: 16px;margin-top: 6px;">
                     </div>
                  </div>
                  <div style="overflow: hidden;margin-left: 40px;"><p style="font-size: 14px;line-height: 24px;margin: 0px;color: #ffffff;font-weight: 300;"><?php echo e($data['address']); ?> <?php echo e($data['city']); ?>, <?php echo e($data['country']); ?>-<?php echo e($data['postal_code']); ?></p></div>
               </div>
               <div style="padding-bottom: 15px;width: 100%;display: inline-block;">
                <div style="float: left;width: 10%;margin-right: 10px;">
                  <div style="width: 28px;height: 28px;background: #ffffff;text-align: center;border-radius: 100%;"> 
                     <img src="<?php echo e(URL::asset('img/resume/world.png')); ?>" alt="web" style="width: 16px;height: 16px;margin-top: 6px;">
                 </div>
                </div>
                <div style="overflow: hidden;margin-left: 40px;"><p style="font-size: 14px;line-height: 24px;margin: 0px;color: #ffffff;font-weight: 300;"><?php echo e($data['linkedIn']); ?></p></div>
               </div>
...
</html><?php /**PATH /home/customer/www/staging.paraclete.ai/public_html/resources/views/user/resume/template5.blade.php ENDPATH**/ ?>